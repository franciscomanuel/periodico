			...
			<section id="sec2">
				<article id="relaciaonadas">
					...
					<aside class="relacionadas2">
						<ul>
							<li><a href="../TV/kerry_advierte_consecuencia_ucrania.php">Kerry advierte a Lavrov de los costes de desestabilizar Ucrania</a></li>
							<li><a href="../TV/prorrusos_movilizan_este_ucrania.php">Grupos prorrusos se movilizan por la secesión del este de Ucrania</a></li>
							<li><a href="../TV/agujeros_negros_antigua_urss.php">Los agujeros negros de la antigua URSS, por PILAR BONET</a></li>
							<li><a href="../TV/OTAN_avisa_a_rusia.php">La OTAN avisa de que un paso más supone "una escalada seria"</a></li>
						</ul>
					</aside>

	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					...
					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">Kiev intenta recuperar el control en el este del país</a></h1>
			...
			<section id="sec2">
				<article id="relaciaonadas">
					...
					<aside class="relacionadas2" id="rel">
						<ul>

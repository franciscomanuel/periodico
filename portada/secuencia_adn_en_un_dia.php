	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					...
					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">Tu secuencia de ADN en un solo día y por el precio de un iPad</a></h1>

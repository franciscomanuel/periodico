	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					...
					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">"Putin cree que Occidente fomenta una revolución contra él"</a></h1>
				...
				<article id="relaciaonadas">
					...
					<aside class="relacionadas2">
						<ul>
							...
							<li><a href="../portada/agujeros_negros_antigua_urss.php">Los agujeros negros de la antigua URSS, por PILAR BONET</a></li>

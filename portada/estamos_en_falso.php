	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					<h6 class="tituloNoticia">FC BARCELONA »</h6>

					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">“Estamos en falso”</a></h1>

					<ul class="listasNoticias">
						<li>Aunque se advirtió de la irregularidad desde dentro del club, el Barcelona obvió validar las solicitudes de los fichajes de menores con la subcomisión de la FIFA creada a tal efecto</li>
						<li>La FIFA echa al Barça del mercado</li>
						<li>“Injusta y desproporcionada”</li>
						<li>La excepcionalidad de un singular club</li>
					</ul>	

					<hr class="suspensivos">
					<p class="autorNoticias">JORDI QUIXANO / LUIS MARTÍN | Barcelona | 12 ABR 2014 - 20:46 CET</p>	
					<hr class="suspensivos">

					<br>

					<img src="../img/pancarta_ante_el_betis.jpg" class="imagenesNoticias">
					<footer>La pancarta del Camp Nou ante el Betis. </footer>
					<hr class="suspensivos">

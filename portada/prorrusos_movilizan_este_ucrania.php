	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					...
					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">Activistas prorrusos declaran la República independiente de Donetsk</a></h1>

	...
	?>
			...
			<section id="sec1">
				<article id="destacadas">
					...
					<h1 class="titulosNoticias"><a onMouseOver="window.open('../relacionadas.html', 'Noticias Relacionadas', 'width=400, height=200')">Bartomeu se enreda con Zubizarreta</a></h1>
